    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-6">
          <div className="p-6 bg-secondary border border-border rounded-md text-foreground shadow-none shadow-primary/20 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 relative z-10 bg-background/20  px-3 py-1.5 rounded-md w-fit text-[10px] uppercase font-bold tracking-widest">
               Active Session
            </div>
          </div>

          <div className="p-6 bg-card border border-border rounded-md space-y-4">
