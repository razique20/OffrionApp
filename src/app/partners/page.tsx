    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex-gap-4">
                <Link href="/auth/register?role=partner" className="px-8 py-4 bg-secondary text-foreground border border-border rounded-md font-bold shadow-none hover:scale-[1.02] transition-all">
                  Become a Partner
                </Link>
                <Link href="/partner/docs" className="px-8 py-4 bg-secondary text-foreground rounded-md font-bold hover:bg-secondary/80 transition-all">
                  Read API Docs
                </Link>
              </div>
            </div>
            <div className="relative aspect-square md:aspect-auto">
              <div className="absolute inset-0 bg-secondary blur-[100px] -z-10"></div>
              <div className="rounded-md h-full overflow-hidden relative">
                <img 
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
               {[
                 ...
                 <div key={i} className="p-8 bg-background border border-border rounded-md text-left hover:border-primary/30 transition-all group">
                    <div className="text-4xl font-black text-secondary mb-4 group-hover:text-foreground/20 transition-colors">0{i+1}</div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-24 text-center">
           ...
           <Link href="/auth/register?role=partner" className="inline-flex items-center gap-3 px-10 py-5 bg-foreground text-background rounded-md text-xl font-bold hover:bg-slate-800 transition-all">
