  ...
  return (
    <div className="relative w-full aspect-square md:aspect-video lg:aspect-square flex items-center justify-center">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="absolute -bottom-10 -right-8 md:-bottom-14 md:-right-12 w-64 md:w-72 bg-card border border-border rounded-md overflow-hidden shadow-none z-30 animate-float" style={{ animationDelay: '1.5s' }}>
