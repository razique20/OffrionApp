    ...
    <section className="py-24 px-6 bg-secondary/20">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <Link href="/deals" className="text-sm font-bold text-primary flex items-center gap-2 hover:translate-x-1 transition-transform">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {deals.slice(0, 4).map((deal) => (
            <div key={deal.id} className="group bg-card border border-border rounded-[32px] overflow-hidden hover:border-primary/30 transition-all hover:shadow-2xl hover:shadow-primary/5">
              <div className="aspect-[4/3] relative overflow-hidden bg-secondary">
                ...
                <div className="absolute top-4 left-4 px-3 py-1 bg-red-500 text-white text-[10px] font-bold rounded-full shadow-lg">
                  {deal.urgencyReason}
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/deals/${deal.id}`} className="p-3 bg-secondary rounded-xl group-hover:bg-primary group-hover:text-white transition-colors">
